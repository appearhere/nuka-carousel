...
var Carousel = _react2['default'].createClass({
  ...
  propTypes: {
    ...
    peaking: _react2['default'].PropTypes.bool,
  ...
  setDimensions: function setDimensions(props) {
    ...
    frameClientRect = frame.getBoundingClientRect();
    firstSlide = frame.childNodes[0].childNodes[0];

    if (firstSlide) {
      firstSlideRect = firstSlide.getBoundingClientRect();

      firstSlide.style.height = 'auto';
      slideHeight = this.props.vertical ? firstSlideRect.height * props.slidesToShow : firstSlideRect.height;
    } else {
      slideHeight = 100;
    }
    ...
    if (typeof props.slideWidth !== 'number') {
      ...
      if (props.vertical) {
        ...
        slideWidth = frameClientRect.width / props.slidesToShow * props.slideWidth;
      }
    }
    ...
    frameWidth = props.vertical ? frameHeight : frameClientRect.width;
